...
void ActiveState::update()
{
    ...
    for (size_t i = 1; i < knee_angles.size(); ++i) 
    {
        ...
        int16_t torque_permille = static_cast<int16_t>((scaled_knee_torque / RATED_TORQUE) * 1000.0);
        ...
        std::cout << "Time: " << t << "\tScaled Hip Torque: " << hip_torque << "\tScaled Knee Torque: " << scaled_knee_torque << "\n";
